                ...
                <div className='maxW flex flex-col justify-center gap-x-30 gap-y-10 items-center lg:flex-row'>
                    <article className='lg:w-[70%]'>
                        ...
                        <div className='flex flex-col text-center gap-x-6 gap-y-6 mt-8 lg:flex-row'>
                            <Link className='bg-[#E7FAF4] border border-[#A5ECD8] font-semibold text-BTN px-3 py-2 rounded-2xl' href="">Fale com um especialista</Link>
                            <Link className='bg-BTN text-white px-3 py-2 rounded-2xl' href="/imoveis">Ver todos imóveis</Link>
                        </div>
                    </article>
